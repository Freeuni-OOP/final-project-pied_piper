    ...
    <section style={{ maxWidth: 900, margin: '0 auto' }}>
      <div style={{ padding: '2rem', background: '#fff', borderRadius: 12, boxShadow: '0 10px 30px rgba(15,23,42,.08)' }}>
        ...
        <p style={{ marginBottom: 24, color: '#4b5563', lineHeight: 1.8 }}>
          Track your lectures, review courses, and connect with classmates
        </p>
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          {auth.token ? (
            ...
            <>
              <Link to="/login" style={{ padding: '0.9rem 1.4rem', background: '#2563eb', color: '#fff', borderRadius: 8, textDecoration: 'none' }}>
                Login
              </Link>
              <Link to="/register" style={{ padding: '0.9rem 1.4rem', background: '#111827', color: '#fff', borderRadius: 8, textDecoration: 'none' }}>
                Register
              </Link>
            </>
          )}
